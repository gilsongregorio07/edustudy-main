            ...
            <div class="statbox widget box box-shadow layout-top-spacing">
                ...
                <div class="widget-content widget-content-area studysets-container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 ">
                            <form method="POST" action="inc/studysets.inc.php" class="row g-3" id="edit_studyset_form">
                               
                                <div class="row bg-light-dark pb-3 rounded mb-2 g-3">
                                    <div class="col-md-12">
                                    <input type="text" class="form-control" id="study_set_id" name="study_set_id" placeholder="Enter term or question" value="<?php echo $_GET['studyset_id'] ?>" hidden required>
                                        <input type="text" class="form-control  w-100" id="title" name="title" placeholder='Enter a title, like "Reviewer for Test"' value="<?php echo $studysets['title'] ?>" required>
                                    </div>
                                    <div class="col-md-12">
                                        <textarea class="form-control  w-100" id="description" name="descriptions" rows="3" placeholder="Add a description..."  required><?php echo $studysets['description'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3"> 
                                    ...
                                    <div class="col-lg-4 d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary" name="update_studyset" style="font-size: 17px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="#ffffff" d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    ...
    // jQuery methods go here...
        ...
        $("#generateCard").on("click", function() {
            ...
            cardDiv.innerHTML = `
                ...
                <div class="col-lg-6 mt-0">
                    <input type="text" class="form-control" id="question_id" name="questions_id[]" placeholder="Enter term or question" value="0" hidden required>
       ...
       // Function to update the labels
        ...
        function showEditableQuestions(){
            ...
            $.each(questions, function(index, record) {
                var cardDiv = document.createElement("div");
                cardDiv.className = "row rounded bg-light-dark p-2 g-3 question-row";
                ...
                cardDiv.innerHTML = `
                    ...
                    <div class="col-lg-6 mt-0">
                        <input type="text" class="form-control" id="questions_id" name="questions_id[]" placeholder="Enter term or question" value="`+record.questions_id+`" hidden required>
                        <input type="text" class="form-control" id="question" name="question[]" placeholder="Enter term or question" value="`+record.question+`" required>
                    </div>
                    <div class="col-lg-6 mt-0">
                        <input type="text" class="form-control" id="answer" name="answer[]" placeholder="Enter description or answer" value="`+record.answer+`" required>
                    </div>
 ...
 // Check for the query parameter in the URL
        ...
        if(editSuccess == 'false' && errorMsg == 'question_count'){
            Swal.fire({
            icon: "error",
            title: "Oops...",
            text: "Only 4 or more questions are allowed to submit. The changes has been reverted",
            });
        }
